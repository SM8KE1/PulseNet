...
Function RunMainBinary
  ExecShell "runas" "$INSTDIR\${MAINBINARYNAME}.exe"
FunctionEnd
...
Function UninstallPreviousMsiIfFound
  ...
  ${If} ${RunningX64}
    ...
    !endif
  ${EndIf}
  ExecWait 'powershell.exe -NoProfile -ExecutionPolicy Bypass -EncodedCommand ' $0
  Return
...
Function .onInstSuccess
  ...
  check_r_flag:
    ...
    IfErrors run_done 0
      ...
      ExecShell "runas" "$INSTDIR\${MAINBINARYNAME}.exe" "$R0"
  run_done:
FunctionEnd
